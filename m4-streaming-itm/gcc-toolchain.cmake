...
set(MCU_CFLAGS "-mcpu=cortex-m4 -mlittle-endian -mthumb -mthumb-interwork -mfloat-abi=hard -mfpu=fpv4-sp-d16")
...
set(COMMON_LFLAGS "-T${CMAKE_SOURCE_DIR}/stm32f407.ld -Wl,--gc-sections -Xlinker -Map=${PROJECT_NAME}.map -specs=nosys.specs")
