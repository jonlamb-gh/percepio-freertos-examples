...
set(MCU_CFLAGS "-mcpu=cortex-m3 -mlittle-endian -mthumb -mthumb-interwork -mfloat-abi=softfp")
...
set(
    COMMON_LFLAGS
    "-T${CMAKE_SOURCE_DIR}/mps2_m3.ld -Wl,--gc-sections -Xlinker -Map=${PROJECT_NAME}.map -nostartfiles -specs=nano.specs --specs=rdimon.specs")
